...
#'
#' Used internally to align MSA or PDB-derived sequences to a reference, with optional plotting of coverage.
#'
#' @param sequences A named character vector of two protein sequences: the reference first, the structure-derived second.
#' @param generate_plot Logical; if \code{TRUE}, returns a ggplot2 coverage plot based on alignment.
...
#'   \item{coverage_plot}{Optional ggplot2 object (or \code{NULL} if \code{generate_plot = FALSE}).}
#' }
#' @export
